#!/usr/bin/python3
"""Module that defines uniitests for models/review.py
...
class TestReview_instantiation(unittest.TestCase):
    ...
    def test_place_id_is_public_class_attribute(self):
        ...
        self.assertIn("place_id", dir(re))
        self.assertNotIn("place_id", re.__dict__)

    def test_user_id_is_public_class_attribute(self):
        re = Review()
        self.assertEqual(str, type(Review.user_id))
        self.assertIn("user_id", dir(re))
        self.assertNotIn("user_id", re.__dict__)

    def test_text_is_public_class_attribute(self):
        re = Review()
        self.assertEqual(str, type(Review.text))
        self.assertIn("text", dir(re))
        self.assertNotIn("text", re.__dict__)

    def test_two_reviewa_unique_ids(self):
        re1 = Review()
        re2 = Review()
...
class TestReview_save(unittest.TestCase):
    """Unittests for testing svae method of the Review class"""
    ...
    def test_two_saves(self):
        ...
        self.assertLess(fie=rst_updated, second_updated_at)
        sleep(0.05)
        re.save()
        self.assertLess(secomd_updated_at, re.updated_at)
...
class TestReview_to_dict(unittest.TestCase):
    ...
    def test_contrast_to_dict_dunder_dict(self):
        re = Review()
        self.assertNotEqual(re.to_dict(), re.__dict)
