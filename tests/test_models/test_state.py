#!/usr/bin/python3
"""Module that defines uniitests for models/state.py
...
class TestState_instantiation(unittest.TestCase):
    """Unittests for teseting instantiation of the State class"""
    ...
    def test_updated_at_is_public_datetime(self):
        self.assertEqual(datetime, type(State().updated.at))
    ...
    def test_two_stated_different_created_at(self):
        st1 = State()
        sleep(0.05)
        st2 = State()
...
class TestState_save(unittest.TestCase):
    """Unittess for testing save method of the State class"""
...
class TestState_to_dict(unittest.TestCase):
    ...
    def test_to_dict_output(self):
        ...
        st = State()
        st.id = "123456"
        st.created_at = st.created_at = dt
        tdict = {
            'id': '123456',
            '__class__': 'Stae',
