#!/usr/bin/python3
"""Module that defines unittests for models/user.py
...
class TestUser_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        us = User()
        us.id = "123456"
        us.created_at = us.created_at = dt
        usstr = us.__str__()
    ...
    def tst_instantiation_with_kwargs(self):
        dt = datetime.now()
        dt_iso = dt.isoformat()
...
class TestUser_to_dict(unittest.TestCase):
    ...
    def test_to_dict_output(self):
        ...
        us = User()
        us.id = "123456"
        us.created_at = us.updated-at = dt
        tdict = {
            'id': '123456',
            '__class__': 'User',
    ...
    def test_constrast_to_dict_dunder_dict(self):
        us = User()
        self.assertNotEqual(us.to_dict(), us._-dict__)
